export function getGridRows() {
  return [
    ...
    { type: 'input', label: 'Sell A (Units)', id: 'sales.A', format: 'number', section: 'ops' },
    ...
    { type: 'input', label: 'Sell B (Units)', id: 'sales.B', format: 'number', section: 'ops' },
    ...
    { type: 'input', label: 'Sell C (Units)', id: 'sales.C', format: 'number', section: 'ops' },
